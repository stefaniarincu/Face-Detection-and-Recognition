...
ground_truth_path = ground_truth_path_root + "task2_barney_gt_testare.txt"
evaluate_results_task2(solution_path, ground_truth_path, "barney", verbose)

ground_truth_path = ground_truth_path_root + "task2_betty_gt_testare.txt"
evaluate_results_task2(solution_path, ground_truth_path, "betty", verbose)

ground_truth_path = ground_truth_path_root + "task2_wilma_gt_testare.txt"
